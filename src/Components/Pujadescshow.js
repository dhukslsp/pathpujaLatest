        ...
        <div>
            ...
            <div style={{ "backgroundColor": "rgb(254 243 234)" }}>
                ...
                <div className="flex justify-center flex-wrap text-black">
                    ...
                    {props.Regular!=="NA"?<PackageCard package = "Regular" pandits = {props.panditsR} prices = {props.pricesR} subpuja = {props.subpujaR} hours = {props.hoursR}/>:<div/>}
                    {props.Premium!=="NA"?<PackageCard package = "Premium" pandits = {props.panditsP} prices = {props.pricesP} subpuja = {props.subpujaP} hours = {props.hoursP}/>:<div/>}
                    {props.Standard!=="NA"?<PackageCard package = "Standard" pandits = {props.panditsS} prices = {props.pricesS} subpuja = {props.subpujaS} hours = {props.hoursS}/>:<div/>}
                </div>
