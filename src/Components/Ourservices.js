                        ...
                        <li className="dropdown lg:inline sm:block px-4 text-black hover:text-purple-700 cursor-pointer font-bold text-base uppercase tracking-wide p-7" >
                            ...
                            <div className="hidden h-auto flex pt-4" id = "dropdown-menu">
                                <ul className="block w-full bg-white shadow px-12 py-8">
                                    <li className="py-1"><a className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer">Rudrabhishek Puja</a></li>
                                    <li className="py-1"><a className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer">Satyanarayana Puja</a></li>
