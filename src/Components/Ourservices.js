                    ...
                    <li className="dropdown lg:inline sm:block px-4 text-black hover:text-purple-700 cursor-pointer font-bold text-base uppercase tracking-wide p-7" >
                        ...
                        <div className="hidden h-auto flex pt-4" id="dropdown-menu">
                            <ul className="block w-full shadow px-12 py-8 hover:text-black list-decimal">
                                ...
                                <li className="py-1" onClick={() => { fetchallnotes("Vehicle Puja") }}><Link to="/AboutService" className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer"><a className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer">Vehicle Puja</a></Link></li>
                                ...
                                <li className="py-1" onClick={() => { fetchallnotes("Sai Sandhya") }}><Link to="/AboutService" className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer"><a className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer">Sai Sandhya</a></Link></li>
                                <li className="py-1" onClick={() => { fetchallnotes("Chatt Puja") }}><Link to="/AboutService" className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer"><a className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer">Chatti Pujaan</a></Link></li>
                                ...
                                <li className="py-1" onClick={() => { fetchallnotes("Lalitha Sahasranama Puja") }}><Link to="/AboutService" className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer"><a className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer">Lalitha Sasharnam Puja</a></Link></li>
                                <li className="py-1" onClick={() => { fetchallnotes("Solah Somvar Udapanan Puja") }}><Link to="/AboutService" className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer"><a className="block text-black font-bold text-base uppercase hover:text-purple-700 cursor-pointer">Solah Sombar Udapanan Puja</a></Link></li>
