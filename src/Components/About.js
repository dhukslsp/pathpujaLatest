      ...
      <div id="aboutcontainer1121" className='flex flex-wrap lg:justify-start sm:justify-center text-white' style={{ "backgroundColor": "#bd4b2f", "paddingTop": "4pc" }}>
        ...
        <p className='w-1/2 sm:ml-0 sm:mr-9 md:ml-auto md:mr-auto lg:ml-auto lg:mr-auto '><div className='media1 m-12 text-black'>
          ...
          <div className='flex justify-center flex-col'>
            <p className='font-extrabold text-4xl mb-6  text-white sm:mt-2 lg:mt-16 lg:text-left sm:text-center'>About Us</p>
            <p className='pb-1 text-white font-bold lg:text-left sm:text-center  text-lg'>
            ...
            <p className='pb-1 text-white font-bold lg:text-left sm:text-center  text-lg'> Therefore, Pathpuja brings you a
