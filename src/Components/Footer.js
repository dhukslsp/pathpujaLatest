    ...
    return (
        <footer className="footer p-10 text-base-content bg-white">
            ...
            <div>
                ...
                <a className="link link-hover font-extrabold text-black flex"><embed src = "/whats-app-svgrepo-com.svg" style = {{"height":"22px"}}/><p className='pl-2'><a href = "https://api.whatsapp.com/message/FQEMMDOIGPGPJ1?autoload=1&app_absent=0" target="_blank">+91 9509238340</a></p></a>
            </div>
            <div>
