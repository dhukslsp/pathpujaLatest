...
const Notestate = (props) => {
    ...
    const fetchallnotes = async (pujaname) => {
        const response = await fetch(`http://43.205.168.224:5000/api/Retrieve/myroute1/`+pujaname, {
            method: 'GET'
        })
    ...
    const save_CustData =async(obj) =>{
        const response = await fetch("http://43.205.168.224:5000/api/insert/CustDetSave", {
            method: 'POST',
    ...
    const cust_sendMail = async(obj) =>{
        const response = await fetch("http://43.205.168.224:5000/api/send/send_email", {
            method: 'POST',
            body: JSON.stringify(obj),
            headers: {
                'content-Type': 'application/json'
    ...
    const fetchPuja = async() =>{
        const response = await fetch("http://43.205.168.224:5000/api/Fetch/myroute1/fetchdetcUst", {
            method: 'get',
          })
          const newjson = await response.json()
          setcustdet(newjson);
    ...
    const fetchdCustDet = async(id) =>{
        const response = await fetch('http://43.205.168.224:5000/api/Fetch/myroute1/fetchdetcUst/'+id, {
            method: 'post',
          })
          const newjson = await response.json();
          const secondres = await fetch("http://43.205.168.224:5000/api/send/send_email1", {
              method: 'POST',
